...
## Model
The main code of the model is [rcs-yolo.yaml]() in the the directory .\main\training. The model weights we pretrained on the brain tumor detection is [best.pt]() in the directory .\runs\.
